...
public class SimSettings {
	...
	/**
	 * The number of F110 cars to simulate.
	 */
	public final int N_CARS;
	...
	/**
	 * Pretty much all it does is initialize all the variables declared above.
	 */
	public static class Builder {
		private int De_Radius = 1;
		private int Detect_Precision = 1;
		private int N_IROBOTS = 4;
		private int N_CARS = 0;
		...
		private boolean IDEAL_MOTION = true;
		...
		public Builder N_CARS(int N_CARS) {
			this.N_CARS = N_CARS;
			return this;
		}
		...
		public Builder CAR_NAME(String CAR_NAME) {
