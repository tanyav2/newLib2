...
public class FollowApp extends LogicThread {
    ...
    public FollowApp(GlobalVarHolder gvh) {
        ...
        System.out.println("destIndexUpTop:"+destIndex);
            ...
            switch(stage) {
                ...
                case PICK:
                    ...
                    if(destinations.isEmpty()) {
                        ...
                        System.out.println("destIndexBeforeIncr:"+destIndex);
                        destIndex++;
                        System.out.println("destIndexAfterIncr:"+destIndex);
                        if(destIndex >= numWaypoints) {
                            System.out.println("Making it zero bitch?");
                            destIndex = 0;
                        }
