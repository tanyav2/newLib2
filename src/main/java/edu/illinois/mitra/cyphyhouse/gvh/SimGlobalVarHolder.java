...
public class SimGlobalVarHolder extends GlobalVarHolder {
	 ...
	 */
	public SimGlobalVarHolder(String name, HashMap<String,String> participants, SimulationEngine engine,
							  TrackedRobot initpos, String traceDir, int trace_driftMax, double trace_skewBound) {
		...
		else if (initpos instanceof ModelF110Car) {
			plat.moat = new RealisticSimMotionAutomation_F110Car(this, engine.getGps());
			plat.moat.start();
		}
		else {
