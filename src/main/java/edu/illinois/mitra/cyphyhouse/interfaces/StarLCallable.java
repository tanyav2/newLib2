...
/**
 * StarLCallable is a base class for all Callable classes intended for use in StarL.
 *
 * In a simulation environment, StarLCallable handles registering the created thread with the
 * simulator engine upon calling call(), and removes the registration when the call completes.
 *
 * All StarLCallables return a list of Objects, making it easy to return a large number
 * of different objects. The protected Object[] results variable is provided,
 * along with a method returnResults(), to easily manage the objects to be returned.
 * 
