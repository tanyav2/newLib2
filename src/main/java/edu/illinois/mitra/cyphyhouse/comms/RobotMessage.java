 ...
 *
 * The ID number is used to target a message to a specific thread. Only threads
 * which are registered MessageListeners for a particular ID will receive messages with that ID.
 * TODO: The following line seems contradictory to the above two lines
 * No two threads may be registered for the same message ID.
 * 
 * @author Adam Zimmerman
 * @version 1.0
 * 
 * @see edu.illinois.mitra.cyphyhouse.interfaces.MessageListener
 * @see edu.illinois.mitra.cyphyhouse.comms.MessageContents
 */
public class RobotMessage implements Traceable {
	...
	public void setContents(MessageContents newContents) {
